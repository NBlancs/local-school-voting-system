		...
		while($row = $query->fetch_assoc()){
			...
			while($crow = $cquery->fetch_assoc()){
				...
				<li>
					...
					<div class="button-group clist">
						<button type="button" class="btn btn-primary btn-sm btn-flat platform" data-candidate-id="'.$crow['id'].'" data-platform="'.$crow['platform'].'" data-fullname="'.$crow['firstname'].' '.$crow['lastname'].'"><i class="fa fa-search"></i> Platform</button>
						<button type="button" class="btn btn-primary btn-sm btn-flat partylist" data-candidate-id="'.$crow['id'].'" data-fullname="'.$crow['firstname'].' '.$crow['lastname'].'"><i class="fa fa-list"></i> Partylist</button>
					</div>
				</li>';
			}
...
$(function(){
	...
	$(document).on('click', '.partylist', function(e){
		...
		$.ajax({
			type: 'POST',
			url: 'get_partylist.php', // Endpoint to fetch partylist information
			data: { candidate_id: candidateId },
			dataType: 'json',
			success: function(response){
				if(response.error){
					...
					$('#partylist').modal('show'); 
					$('.candidate').html(fullname);
					$('#partylist_view').html(response.partylist); 
				}
			}
		});
	});
