            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                <thead>
                  <th class="hidden"></th>
                  <th>Position</th>
                  <th>Party List</th> <!-- New column for Party List -->
                  <th>Photo</th>
                  <th>Firstname</th>
                  <th>Lastname</th>
                  <th>Platform</th>
                ...
                <tbody>
                  <?php
                    $sql = "SELECT candidates.id AS canid, candidates.*, positions.description AS position_description, tbl_partylist.partylist AS partylist_name FROM candidates 
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['partylist_name']."</td> <!-- Display the party list name -->
                          <td>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_partylist').val(response.partylist_id).html(response.partylist_name);    
